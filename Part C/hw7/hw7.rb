...
class GeometryValue 
  ...
  # line_result can be NoPoints, Point, Line, VerticalLine, LineSegment
...
class LineSegment < GeometryValue
  ...
  def intersectWithSegmentAsLineResult seg
    ...
    if real_close(seg1[0],seg1[2]) # vertical line
      aXstart,aYstart,aXend,aYend,bXstart,bYstart,bXend,bYend = seg1[1] >= seg2[1] ? seg2 + seg1 : seg1 + seg2
      ...
      aXstart,aYstart,aXend,aYend,bXstart,bYstart,bXend,bYend = seg1[0] >= seg2[0] ? seg2 + seg1 : seg1 + seg2
